const Industries = () => {
  const industries = [
    {
      iconPath: "https://i.postimg.cc/DZgs8vhb/20-support-24-7.webp",
      name: "Healthcare",
      description: "Patient management, compliance automation, intelligent scheduling",
      metrics: "40hrs saved/month",
    },
    {
      iconPath: "https://i.postimg.cc/RFRfNSmZ/15-partnership-handshake.webp",
      name: "Hospitality",
            ...
            return (
              ...
              >
                <div className="flex items-start justify-between mb-6">
                  <div className="icon-wrapper-premium w-14 h-14">
                    <img src={industry.iconPath} alt={industry.name} className="icon-image-gold w-10 h-10 object-contain" />
                  </div>
